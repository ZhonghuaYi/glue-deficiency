...
def template_match(sample, target_template, count):
...
def class1_defect1(method):
    ...
    if method == 'threshold_segment':
        ...
        template_match(sample, target_template, count)
...
if __name__ == '__main__':
    class1_defect1(method='template_match')
